...
<head>
	...
	<style>
		...
		*,
		...
		@media (min-width: 993px) .checkout-container .cart-container {
			width: 45%;
		}
		...
		<main id="main-area">
			...
			<div class="cart-container bg-light">
				...
				<form action="<%=request.getContextPath()%>/member/ecpay" METHOD="post">
					...
					<div
						style="width:40%;margin:auto;border-radius:10px;margin-top:100px; box-shadow: 0px 0px 6px #b1a7a6;padding-bottom:50px">
						<table class="table caption-top">
							<hr
								style="position:relative;top:250px;background-color:#e6ccb2;height:3px;width:80%;margin:auto;border-radius:80px">
							<div
								style="position:relative;top:150px; border-bottom: 1px #dad7cd dashed;width:80%;margin:auto;">
							</div>
							<tbody>
								<c:forEach var="memberBillVO" items="${list}">
									...
									<div id="collapseSummary" class="summary-section">
										<tr>
											<td>
												<div style="font-size:20px;text-align:left;margin-left:10px;">項目明細</div>
											</td>

										</tr>
										<tr>
											<td>
												<div style="text-align:left;margin-left:100px;">管理費用</div>
											</td>
											<td>
										...
										<tr>
											<td>
												<div style="text-align:left;margin-left:100px;">車位清潔費用</div>
											</td>
											<td>
										...
										<tr>
											...
											<td>
												<div style="text-align:left;margin-left:100px;">合計</div>
											</td>
											<td>
												<div><span><input name="sum" type='hidden' value="<c:out value="
															${memberBillVO.managementFees+
															memberBillVO.parkingSpaceCleaningFee}" />" style="broder:0"
														id="total-price" class="total-line_price">NT$
														<c:out
															value="${memberBillVO.managementFees+ memberBillVO.parkingSpaceCleaningFee}" />
													</span></div>
											</td>
										</tr>
									</div>
