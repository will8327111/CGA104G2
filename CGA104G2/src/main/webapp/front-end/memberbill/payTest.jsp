...
<!-- <h1 class="store-name">帳單明細</h1> -->
	...
	<form action="<%=request.getContextPath()%>/member/ecpay" METHOD="post">
			...
			<button id='button' type="button" class="btn btn-primary" >前往繳費</button>
...
<!--       			</div> -->
			...
			<script>
			 $(document).on('click', '#transfer', function () {
			        Swal.clickConfirm();
			        fetch("../../member/ecpay?action=transfer", {
						method: 'get'
					})
					window.location.href = "../../front-end/memberbill/transfer.jsp"
		     });
			...
			document.getElementById("button").onclick = function () {
		        Swal.fire({
		            title: "請選擇繳費方式",
		            html: "<button id='transfer' type='button' class='btn btn-primary'>匯款</button>"
		            +"<button id='buyToken' type='button' class='btn btn-primary'>刷卡</button>"
