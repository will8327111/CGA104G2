					...
					<% Integer memid=(Integer) session.getAttribute("ID"); %>
						<% MemberBillVO memberBillVO=(MemberBillVO) request.getAttribute("memberBillVO");%>
							...
							<head>
								...
								<!--=============Google Font ===============-->
								<link href="https://fonts.googleapis.com/css?family=Lato:300&display=swap"
									rel="stylesheet">
								<!-- !!固定!! favicon 網址列屬於網站的小圖示 -->
								<link rel="shortcut icon"
									href="<%= request.getContextPath() %>/resources/back-end/assets/images/main/favicons/favicon2.ico"
									type="image/x-icon">
								...
								<link rel="stylesheet" type="text/css"
									href="<%= request.getContextPath() %>/resources/front-end/assets/css/jquery.bxslider.min.css">
								<link rel="stylesheet" type="text/css"
									href="<%= request.getContextPath() %>/resources/front-end/assets/css/reset.css">
								<link rel="stylesheet" type="text/css"
									href="<%= request.getContextPath() %>/resources/front-end/assets/css/layout.css">
								<link rel="stylesheet" type="text/css"
									href="<%= request.getContextPath() %>/resources/front-end/assets/css/parts.css">
								<!--modaal-->
								<link rel="stylesheet" type="text/css"
									href="<%= request.getContextPath() %>/resources/front-end/assets/css/modaal.min.css">
									...
									<nav id="pc-nav">
										...
										<div>
											<h1><a href="<%= request.getContextPath() %>/front-end/web/front-index2.html"><img
														src="<%= request.getContextPath() %>/resources/front-end/assets/img/logo11_trans4.png"
														alt="陪你e生e世　社區服務平台"
										...
										<div id="login-div">
											<a href="#"><button class="cap" id="login"
													data-tippy-content="<div class='inner-cap'><p>住戶登入/登出。</p><p>社區住戶專用。</p></div>"><i
														...
														class="fa-solid fa-right-to-bracket"></i><label
										...
										<div id="out-div">
											<a href="#"><button class="cap" id="out"
													data-tippy-content="<div class='inner-cap'><p>住戶訊息通知。</p><p>檢視您的個人訊息。</p></div>"><i
														style="font-size: 1rem;" class="fa-solid fa-bell"></i><label
														style="font-size: 1rem;"> 通知</label></button></a>
										</div>
									</ul>
									<!--導覽列 end-->
								</header>
								...
								<div id="container">
									<main id="main-area">
										...
										<%-- <input type="hidden" value="${billGroup2}" name="billGroup"> --%>
												...
												<h3 style="width: 40%;margin: auto;font-size: 1.75rem;">您的帳單繳費即將完成!</h3>
												<div class="alert alert-primary d-flex mt-3" role="alert">
     											 	<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-info-circle mr-3 flex-shrink-0" viewBox="0 0 16 16">
       											 	<path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"></path>
       											 	<path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"></path>
      												</svg>     											
      											<div style="box-sizing: border-box">此帳單所需支付的金額為 <b>NT$ 3000</b></div>
    											</div>
												...
												<div class="card-body" style="width:40%">
													...
													<div id="bank-transfer-content" class="text-break">
														<p
															style="text-align: center;font-size:25px;text-decoration:underLine">
															<span>匯款帳號</span>
														</p>
														<p style="text-align: center;">
															<span style="color: rgb(71, 85, 119);">中國信託銀行(822)
																桃園分行</span>
														</p>
														<p style="text-align: center;">
															<span style="color: rgb(71, 85, 119);">帳號
																808123456789</span>
														</p>
														<p style="text-align: center;">
														...
														<p style="text-align: center;">對帳無誤則不另行通知，系統將更改為已付款
															<span><img style="width:5%;margin-bottom:5px"
																	src="https://cdnjs.cloudflare.com/ajax/libs/emojione/2.0.1/assets/svg/1f60a.svg"></span>
														</p>
													</div>
												</div>
												...
												<div class="card-body" style="width:40%;">
													<h2>驗證您的付款狀態:</h2>
													<form method="post"
														action="<%=request.getContextPath()%>/member/ecpay" name="form2"
														...
														<div>
															...
															<div class="img-uploader form-group">
																<div id="dropzone" class="dropzone dz-clickable"
																	style="width:80%;height:30%;margin: auto auto 5% auto;">
																	<div class="dz-default dz-message"
																		style="padding-top:20px;position:relative">
																		<span>
																		<span id="imgspan">
																		<svg class="svg-icon" id="Layer_1"
																				data-name="Layer 1"
																				xmlns="http://www.w3.org/2000/svg"
																				viewBox="0 0 24 24"
																				style="width:100px;height:100px">
																				<path
																					d="M19.33,9.77A5.8,5.8,0,0,0,8.48,7.36a2.87,2.87,0,0,0-1.54-.44A2.92,2.92,0,0,0,4,9.82a4.16,4.16,0,0,0,1.49,8.05H9.12a.65.65,0,1,0,0-1.3H5.51a2.86,2.86,0,0,1-.65-5.65l.61-.14-.12-.62a1.66,1.66,0,0,1,0-.32,1.62,1.62,0,0,1,2.88-1l.72.88.4-1.07a4.51,4.51,0,0,1,8.73,1.57L18,11l.64,0a2.79,2.79,0,0,1-.11,5.57H14.69a.65.65,0,0,0,0,1.3h3.87a4.09,4.09,0,0,0,.77-8.1Z">
																				</path>
																				<path
																					d="M11.93,21.32a.65.65,0,0,0,.65-.65V13.73l1.08,1.09a.7.7,0,0,0,.46.19.66.66,0,0,0,.46-.19.64.64,0,0,0,0-.92l-2.19-2.2h0l-.45-.46-.46.46h0l-2.2,2.2a.65.65,0,0,0,.92.92l1.09-1.09v6.94A.65.65,0,0,0,11.93,21.32Z">
																				</path>
																			</svg>
																		</span>
																			<br>
																			<label for="file">上傳繳費收據</label>
																			<input type="file" name="file" id="file" style="position: absolute;opacity: 0;width: 425px;height: 150px;border: 1px solid white;top: -2%;left: -2%;"/>
																		</span>
																	</div>
																</div>
															</div>
															...
															<div>
																...
																<jsp:useBean id="select2"
																	class="com.memberbill.model.MemberBillService" />
...
<!-- 																				selected value="memberBillId"> -->
<%-- 																				<c:forEach var="billDate" --%>
<%-- 																					items="${list1}"> --%>
<!-- 																					<option id="date" -->
...
<!-- 																</div> -->
															...
															<div>
																<jsp:useBean id="select"
																	class="com.bank.model.BankService" />
																<span style="margin-right: 20px">匯款銀行:</span>

																<select name="bankId" style="box-shadow:2px 2px 5px #d8e2dc;font-weight:100;background: #ffffff;color:#6c757d;text-align:center;border:#d8e2dc .2px solid;border-radius: 5px;width:200px;height:30px">
																	<div class="btn-group">
																		<option disabled selected value="請選擇銀行" type="button" class="btn btn-danger dropdown-toggle"
																		...
																		<c:forEach var="BankVO" items="${select.all}">
																			<option class="dropdown-item"
																				value="${BankVO.bankId}">
																				${BankVO.bankId}|${BankVO.bankName}
																			</option>
																		</c:forEach>
																	</div>
																</select>
															</div><br>
														<span style="margin-right: 20px">帳號後五碼:</span>
...
<!-- 																		<input type="text" -->
<!-- 																			class="form-control reference_id-input" -->
<!-- 																			id="reference_id-input" name="reference_id" -->
<!-- 																			placeholder="匯款後五碼" maxlength="255" -->
<!-- 																			style="width:30%"> -->
<!-- 																		<label for="reference_id-input" type="TEXT" -->
<!-- 																			name="bankNumber" id="five"></label> -->

																		<td><input type="TEXT" name="bankNumber"
																				id="five" placeholder="請輸入後五碼" style="box-shadow:2px 2px 5px #d8e2dc;font-weight:100;background: #ffffff;color:#6c757d;text-align:center;border:#d8e2dc .2px solid;border-radius: 5px;width:200px;height:30px;translate: -14px 9px;"/>
															...
															<input type="hidden" value="${vo1.memberBillId}"
																name="memberBillId">
													...
													<ul>
														<c:forEach var="message" items="${errorMsgs}">
															...
															<input type="submit" value="提交" class="btn btn-primary_1" style="display: block;margin-left: 85%">
														</div>
													</form>
												</div>
								...
								let preview_img = function (file) {
					                ...
					                //讀取檔案 (reader.readAsDataURL(file);)
					                reader.readAsDataURL(file); // 讀取檔案
					                reader.addEventListener("load", function () {
					                	document.querySelector("#imgspan").innerHTML="<img src=" + reader.result + ">"
