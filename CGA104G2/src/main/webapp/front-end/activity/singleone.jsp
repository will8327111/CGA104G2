...
<!--延遲載入-->
<script
	src="<%=request.getContextPath()%>/resources/front-end/assets/js/lazyload.min.js"></script>
...
@font-face {
	font-family: 'huninn';
	src:
		url('<%=request.getContextPath()%>/resources/front-end/assets/font/jf-openhuninn-1.1.ttf')
		format("truetype");
}
...
<body>
	...
	<header id="header">
		...
		<nav id="pc-nav">
			<!--!!固定!! logo-->
			<div>
				<h1 style="width: 166px">
					<a
						href="<%=request.getContextPath()%>/front-end/web/front-index2.html"><img
						src="<%=request.getContextPath()%>/resources/front-end/assets/img/logo11_trans4.png"
						alt="陪你e生e世　社區服務平台"
						style="width: 100%; display: flex; justify-content: flex-start; flex-direction: inherit;"></a>
				</h1>
			</div>
		</nav>
		...
		<ul>
			<div>
				<a
					href="<%=request.getContextPath()%>/front-end/activity/homepage3.html"><button
						class="cap" id="mylist"
						data-tippy-content="<div class='inner-cap'><p>回到活動首頁</p><p>社區住戶專用。</p></div>">
						<i style="font-size: 1rem;" class="fa-solid fa-house"></i><label
							style="font-size: 1rem;">活動首頁</label>
					</button></a>
			</div>
		</ul>
		<ul>
			<div>
				<a
					href="<%=request.getContextPath()%>/front-end/activity/mylist.html"><button
						class="cap" id="mylist"
						data-tippy-content="<div class='inner-cap'><p>我舉辦的活動</p><p>社區住戶專用。</p></div>">
						<i style="font-size: 1rem;" class="fa-solid fa-table-list"></i><label
							style="font-size: 1rem;">我舉辦的活動</label>
					</button></a>
			</div>
		</ul>
		<ul>
			<div>
				<a
					href="<%=request.getContextPath()%>/front-end/activity/myaddlist.html"><button
						class="cap" id="login"
						data-tippy-content="<div class='inner-cap'><p>我參加的活動</p><p>社區住戶專用。</p></div>">
						<i style="font-size: 1rem;" class="fa-solid fa-user-plus"></i><label
							style="font-size: 1rem;"> 我參加的活動</label>
					</button></a>
			</div>
		</ul>
		<ul>
			<div>
				<a
					href="<%=request.getContextPath()%>/front-end/activity/addactivity.html"><button
						class="cap" id="add"
						data-tippy-content="<div class='inner-cap'><p>新增活動。</p><p>社區住戶專用。</p></div>">
						<i style="font-size: 1rem;" class="fa-solid fa-plus"></i><label
							style="font-size: 1rem;"> 新增活動</label>
					</button></a>
			</div>
		</ul>
	...
	<div id="container">
		...
		: "已成團 目前人數:" + (activityVO.getActCurrentCount())%>"
					...
					<div class="inputfield">
						...
						<c:if
							test="<%=(activityVO.getActCurrentCount()) == (activityVO.getActMaxCount())%>">
							<label>活動人數</label>
							<input type="text" class="input" value="已額滿" readonly
								style="background-color: transparent; border: 0">
						</c:if>
					...
					<div class="inputfield">
						<label>檢舉活動</label> <input type="submit" value="檢舉活動" class="btn"
							onclick="report()" style="width: 100px; margin-left: 41px;">
					</div>
					...
					<form>
						...
						<div class="inputfield">
							<input type="button" value="送出" class="btn"
								style="width: 100px; margin-left: 250px" onclick="getReply()">
						</div>
					</form>
				</div>
			</div>
	...
	<footer id="footer">
		...
		<div id="g-nav">
			<div id="g-nav-list">
				<ul>
					<li><a href=""></a> <img
						src="<%=request.getContextPath()%>/resources/front-end/assets/img/logo11_trans3.png"
	...
	<!--jQuery-->
	<script
		src="<%=request.getContextPath()%>/resources/front-end/assets/js/jquery-3.4.1.min.js"></script>
	<!--news tickerー-->
	<script
		src="<%=request.getContextPath()%>/resources/front-end/assets/js/jquery.bxslider.min.js"></script>
	<!--背景線延伸效果-->
	<script
		src="<%=request.getContextPath()%>/resources/front-end/assets/js/scrollgress.min.js"></script>
	<!--apang 動畫-->
	<script
	...
	<!--other-->
	<script
		src="<%=request.getContextPath()%>/resources/front-end/assets/js/modaal.min.js"></script>
	<script
		src="<%=request.getContextPath()%>/resources/front-end/assets/js/script.js"></script>
	<script
