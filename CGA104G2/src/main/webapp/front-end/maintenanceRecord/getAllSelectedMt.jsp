...
<%
Integer maintenanceStatus = Integer.parseInt(request.getParameter("maintenanceStatus"));
String memberAc = request.getParameter("memberAc").trim();
MaintenanceRecordService maintenanceSvc = new MaintenanceRecordService();
List<MaintenanceRecordVO> list = maintenanceSvc.memberGetAllSelected(maintenanceStatus, memberAc); // 設定Account的getAll集合
pageContext.setAttribute("list", list);
%>
<%
MaintenanceRecordService maintenanceSvc2 = new MaintenanceRecordService();
MaintenanceRecordVO maintenanceRecordVO = maintenanceSvc2.findByMtStatus(maintenanceStatus); // 設定Account的getAll集合
pageContext.setAttribute("maintenanceRecordVO", maintenanceRecordVO);
%>
			...
			<div class="container">
				<div class="row align-items">
					...
					<form method="get"
						...
						<input type="hidden" name="action" value="getOneMtById2">
