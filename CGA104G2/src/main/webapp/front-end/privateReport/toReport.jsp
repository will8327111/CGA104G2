			...
			<div>
				<form method="post"
					...
					<textarea class="btn btn-outline-primary"
						name="privateReportContent" rows="5" cols="45" required></textarea>
					<p>
						回覆附圖:<br> <input type="file" accept="image/*"
							class="btn btn-outline-primary" name="privateReportPic"
							value="點我上傳圖片">
					<p>
						<input type="hidden" name="privateReportId"
							...
							type="hidden" name="privateReportStatus" value="0"> <input
						...
						<input type="button" class="btn btn-outline-primary" value="回上一頁"
