				...
				<div class="page-title">
					<div class="row">
						<div class="col-12 col-md-6 order-md-1 order-last">
							...
							<h3>管理員資料修改</h3>
							<p class="text-subtitle text-muted">歡迎來到陪你e生e世 服務平台：後台管理員資料修改</p>
						...
						<div class="card-body">
							<body>
								...
								<form method="get"
									...
									<div>
										<input type="submit" value="返回所有管理員基本資料">
									</div>
								</form>
								...
								<FORM METHOD="get"
									...
									<table class='table table_sm'>
										<tr>
											<th>管理員編號:<font color=red><b>*</b></font></th>
											<td>${param.bmId}</td>
										</tr>
										<tr>
											<th>管理員姓名:</th>
										...
										<tr>
											<th>帳號:<font color=red><b>*</b></font></th>
											<td>${param.bmAccount}<input type="hidden" name="bmAccount" size="45"
												value="${param.bmAccount}" /></td>
										</tr>
										<tr>
											<th>密碼:</th>
										...
										<tr>
											...
											<td><input type="TEXT" name="bmEmail" size="45"
												value="${param.bmEmail}" /><span style="color: red">${errorMsgs3.bmEmail}</span></td>
										</tr>
										<tr>
											<th>帳號狀態:</th>
											<td><select class="Status" name="bmStatus">
													...
													<option value="1"
														${(backstageAccountVO.bmStatus==1)?'selected': ''}>啟用</option>
											</select></td>
										</tr>
									</table class='table table_sm'>
									<br> <input type="hidden" name="action" value="update">
									<input type="hidden" name="bmId" value="${param.bmId}">
