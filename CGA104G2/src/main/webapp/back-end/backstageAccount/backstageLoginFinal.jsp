...
<head>
	<meta charset="UTF-8">
	<title>陪你e生e世 社區服務平台 後台管理員登入介面</title>
	<style>
    ...
    ===================================*/
		...
		.slider-item01 {
			background: url(<%=request.getContextPath()%>/resources/front-end/assets/img/work_l.jpg);
			opacity: 80%;
			border-radius: 5px;
		}
		...
		<div class="form login">
			...
			<form method="post" action="../../back-end/backstageAccount/backstageLogin.do">
				<div class="input-field">
					<input type="text" name="bmAccount" placeholder="輸入您的帳號" >
					<i class="uil-user-circle"></i>
				</div>
				<div class="input-field">
					<input type="password" name="bmPassword"  class="password" placeholder="輸入您的密碼" >
				...
				<div class="checkbox-text">
					<div class="checkbox-content">
          			...
          			<a href="http://localhost:8081/CGA104G2/back-end/backstageGetPassword/passwordForgotten.jsp">忘記密碼?</a>
				</div>
			...
			<div class="login-signup">
                    <span class="text">還不是用戶?
                        <a href="#" class="text signup-link">請先找後台管理員註冊</a>
                    </span>
			</div>
