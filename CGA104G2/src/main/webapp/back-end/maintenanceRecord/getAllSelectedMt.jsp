...
List<MaintenanceRecordVO> list = maintenanceSvc.getAllSelected(maintenanceStatus); // 設定Account的getAll集合
				...
				<div class="page-title">
					<div class="row">
						<div class="col-12 col-md-6 order-md-1 order-last">
							...
							<h3>維修下拉式選單頁面</h3>
							<p class="text-subtitle text-muted">歡迎來到陪你e生e世 服務平台：維修下拉式選單頁面</p>
