...
<%
BackstageCapabilitiesVO backstageCapabilitiesVO = (BackstageCapabilitiesVO) request
		.getAttribute("backstageCapabilitiesVO"); //EmpServlet.java(Concroller), 存入req的empVO物件
%>
				...
				<div class="page-title">
					<div class="row">
						<div class="col-12 col-md-6 order-md-1 order-last">
							...
							<h3>權限功能修改</h3>
							<p class="text-subtitle text-muted">歡迎來到陪你e生e世 服務平台：權限功能修改完成頁面</p>
						...
						<div class="card-body">
							...
							<h3><font color="red"><b>[權限功能修改完成!]</h3><br>
								...
								<table class='table table_sm'>
									...
									<tr>
										<td>${backstageCapabilitiesVO.bmCapabilitiesId}</td>
										<td>${backstageCapabilitiesVO.bmCapabilitiesName}</td>
										<td>${backstageCapabilitiesVO.bmCapabilitiesContent}</td>
									</tr>
								</table>
