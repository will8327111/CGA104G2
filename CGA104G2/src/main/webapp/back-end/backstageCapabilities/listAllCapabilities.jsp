				...
				<div class="page-title">
					<div class="row">
						<div class="col-12 col-md-6 order-md-1 order-last">
							...
							<h3>權限功能列表</h3>
							<p class="text-subtitle text-muted">歡迎來到陪你e生e世 服務平台：權限功能列表</p>
							...
							<body>
								...
								<div>
									<FORM METHOD="get"
										...
										<input type="submit" value="新增權限功能" style="float: left">
											...
											<td>
												<FORM METHOD="get"
													...
													<input type="submit" value="修改"> <input
														...
														value="${backstageCapabilitiesVO.bmCapabilitiesId}">
