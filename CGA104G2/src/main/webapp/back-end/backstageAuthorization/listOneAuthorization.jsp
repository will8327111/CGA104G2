				...
				<div class="page-title">
					<div class="row">
						<div class="col-12 col-md-6 order-md-1 order-last">
							...
							<h3>${backstageAccountVO.bmName}先生/小姐的權限</h3>
							<p class="text-subtitle text-muted">歡迎來到陪你e生e世 服務平台：個人權限</p>
							...
							<body>
								...
								<table class='table table_sm'>
									...
									<c:forEach var="backstageAccountVO" items="${list}">
										<tr>
											<td>${backstageAccountVO.bmCapabilitiesId}</td>
											<td>${backstageAccountVO.bmCapabilitiesName}</td>
											<td>${backstageAccountVO.bmCapabilitiesContent}</td>
										</tr>
									</c:forEach>
								</table>
