				...
				<div class="page-title">
					<div class="row">
						<div class="col-12 col-md-6 order-md-1 order-last">
							...
							<h3>權限新增</h3>
							<p class="text-subtitle text-muted">歡迎來到陪你e生e世 服務平台：權限新增</p>
						...
						<div class="card-body">
							<body>
								...
								<form method="get"
									...
									<div>
										<input type="submit" value="返回所有管理員權限功能">
									</div>
								</form>
								<br>
								<div> <font color="red"><b>${errorMsgs}</b></div>
								<br>
								<h4>資料新增:</h4>
								...
								<FORM METHOD="get"
									...
									<table id="table-1" class='table table_sm'>
										...
										<tr>
											<th>權限功能名稱:</th>
											<td><select name="bmCapabilitiesId">
													<c:forEach var="backstageAuthorizationVO" items="${list4}">
														<option
															value="${backstageAuthorizationVO.bmCapabilitiesId}">${backstageAuthorizationVO.bmCapabilitiesName}</option>
													</c:forEach>
											</select></td>
										</tr>
									</table>
