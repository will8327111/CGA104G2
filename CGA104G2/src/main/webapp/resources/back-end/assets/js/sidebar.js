...
document.writeln("                            <span>公佈欄</span>");
document.writeln("                        </a>");
document.writeln("                        <ul class=\'submenu \'>");
document.writeln("                            <li class=\'submenu-item \'>");
document.writeln("                                <a href=\'.html\'>訪客</a>");
document.writeln("                            </li>");
document.writeln("                            <li class=\'submenu-item \'>");
document.writeln("                                <a href='../../back-end/mail/mailIndexBootStrap.html'>郵件</a>");
document.writeln("                            </li>");
document.writeln("                            <li class=\'submenu-item \'>");
document.writeln("                                <a href=\'.html\'>Divider</a>");
document.writeln("                            </li>");
document.writeln("                        </ul>");
document.writeln("                    </li>");
document.writeln("");
