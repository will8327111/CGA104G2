...
<div class="form-group">
    <br>
    <h4>${ "住戶管理" }</h4>
    <li><a href="${pageContext.request.contextPath}/member/listAllMember.jsp">修改住戶資料</a> update all Members
        <a href="${pageContext.request.contextPath}/member/listAllMember2.jsp">修改住戶資料-地址</a> update all Members
        <br><br></li>
    <li><a href="${pageContext.request.contextPath}/member/addMember.jsp">新增住戶資料</a> add Members <br><br></li>

    <h4>${ "住戶查詢" }</h4>

    <li><a href="${pageContext.request.contextPath}/member/select_page.jsp">查詢住戶資料</a> search one Members <br><br>
    </li>
